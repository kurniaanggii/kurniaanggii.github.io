...
<div class="container">
	<div class="row">
		...
		<hr class="bottom-line">
			...
			<hr class="bottom-line">
			<br></br><p>Gabungan Kelompok Tani (GAPOKTAN) Harjo Makmur yang terletak di Desa toto Harjo, Kec. Purboolinggo, Kab. Lampung Timur, merupakan organisasi bidang pertanian tingkat desa di bawah naungan Desa Toto Harjo dan Kementrian Pertanian.</p>
			<br></br><hr class="bottom-line"><br></br>
			</div><h1>Kegiatan</h1>
<ol><li>Gapoktan wajib merekaps RDKK yang dibuat Kelompok sebagai bentuk pesanan pupuk kepada pemerintah melalui distributor dan pengecer setiap awal musim tanam untuk kebutuhan pupuk satu tahun.
</li><li>Mengikuti dan menghadiri undangan rapat dari dinas terkait, untuk menerima informasi dan teknologi pertanian, kemudian disampaikan kepada para kelompok dan para petani.
</li><li>Mengikuti kegiatan pemerintah deşa (musdus) yang diadakan setiap tahun oleh Kepala Desa, sebagai bentuk partisipasi kelompok tani dan para petani untuk ikut serta membangun perekonomian deşa melalui sektorpertanian
</li><br></ol></br>
<h2>Kemitraan</h2>
<ol><li>Gapoktan menjalin hubungan kerja dengan kelompok penggerak perekonomian yang lain dan bekerjasama selalu diciptakan Gapoktan, P3A, Pengecer pupuk yang masing-masing kelompok ini selalu di bina oleh dinasnya masing-masing. Tiga kelompok ini mempunyai sasaran yang sama yaitu bagaimana pendapatan petani meningkat. Oleh şebab itü tiga wadah ini menjadi bagian dari kegiatan LPMD, yang semua ini menjadi binaan Bapak Kepala Desa.
</li><li>Gapoktan mencari kemitraan pihak ketiga agar prodüksi petani meningkat
</li></ol>
			</p>
			<div class="col-md-12 text-center">
			<hr class="bottom-line">
